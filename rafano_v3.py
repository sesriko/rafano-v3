...
/c KODE [TF] /b KODE"""
                    ...
                    elif first in ["/scan","!scan","/scanall","/scanfull","/scanbuy","/bos","/bow"]:
                        # /scan = BO EMA50 + BOB EMA200 last candle ONLY (simple, no /scan bo /scan bob)
                        sf = "BO_BOB"  # BO50 + BOB200 last candle - yang lu minta
                        # /scan bos /scan bow /scan all masih ada, tapi /scan bo dan /scan bob dihapus
                        ...
                        if len(parts)>=2:
                            ...
                            # bo dan bob dihapus sesuai request
